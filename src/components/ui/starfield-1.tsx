...
const Starfield = ({
  starColor = 'rgba(255,255,255,0.9)', // Brighter stars for better visibility
  ...
  warpFactor = 10,
  opacity = 0.1,
  speed = 0.45, // Slightly faster for noticeable movement
  quantity = 800, // More stars to fill the background
}: StarfieldProps) => {
  ...
  return (
    <div style={{ position: 'absolute', width: '100%', height: '100%', top: 0, left: 0 }} className="z-0 pointer-events-none">
